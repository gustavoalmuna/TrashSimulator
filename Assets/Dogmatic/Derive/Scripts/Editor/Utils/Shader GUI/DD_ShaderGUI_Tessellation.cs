...
{
    public class DD_ShaderGUI_Tessellation : ShaderGUI
    {
        ...
        void DrawMainSettings()
        {
            ...
            MaterialProperty tessellation = FindProperty("_Tessellation", m_materialProperties);

            m_materialEditor.ShaderProperty(tiling, new GUIContent("Tiling", "Uniform tiling for all maps"));
            m_materialEditor.ShaderProperty(tessellation, new GUIContent("Tessellation", "Tessellates the mesh for more detail on physical displacement"));
        }
        ...
        void DrawAlbedoSettings()
        {
            ...
            m_colorSource = (COLORSOURCE)EditorGUILayout.EnumPopup("Main Color Source", m_colorSource);
