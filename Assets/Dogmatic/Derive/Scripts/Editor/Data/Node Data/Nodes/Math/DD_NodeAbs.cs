...
{
    [Serializable]
    public class DD_NodeAbs : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Abs.ToString());
        ...
        /// <summary>
        /// Performs the actual node operation setting the output to the input with positive sign
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Abs(inputTexture, m_outputs[0].outputTexture);
