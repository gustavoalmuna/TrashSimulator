...
{
    [Serializable]
    public class DD_NodeNegate : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Negate.ToString());
        ...
        /// <summary>
        /// Performs the actual node operation rounding thi input DOWN to the next integer
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.TextureMath(inputTexture1, inputTexture2, m_outputs[0].outputTexture, MATHNODETYPE.Multiply);
