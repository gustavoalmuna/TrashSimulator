...
{
    [Serializable]
    public class DD_NodeRotate : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Rotate.ToString());

            EditorGUI.BeginChangeCheck();
            m_degrees = DD_GUILayOut.Slider("Rotation", m_degrees, -180, 180);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Rotate(inputTexture, m_outputs[0].outputTexture, m_degrees);
