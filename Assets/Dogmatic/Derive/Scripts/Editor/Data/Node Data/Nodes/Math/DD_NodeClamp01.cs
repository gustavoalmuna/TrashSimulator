...
{
    [Serializable]
    public class DD_NodeClamp01 : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel("Clamp 0-1");
        ...
        /// <summary>
        /// Performs the actual node operation clamping the input values between 0 and 1
        /// </summary>
        void Perform()
        {
