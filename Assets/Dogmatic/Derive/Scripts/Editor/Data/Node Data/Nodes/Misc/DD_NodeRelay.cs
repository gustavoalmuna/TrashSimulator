...
{
    [Serializable]
    public class DD_NodeRelay : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Relay.ToString());
        ...
        /// Sets Output = Input with the same data type as the inputting node.
        /// </summary>
        void Perform()
        {
