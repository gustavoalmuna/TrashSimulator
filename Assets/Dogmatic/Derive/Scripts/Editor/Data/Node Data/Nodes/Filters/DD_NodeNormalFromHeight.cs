...
{
    [Serializable]
    public class DD_NodeNormalFromHeight : DD_NodeBase
    {
        #region public variables
        public float m_normalStrength = 1;
        public float m_overdetermination = 1;
        ...
        bool m_showNormalMapSettings = true;
        #endregion

        #region constructor
        public DD_NodeNormalFromHeight()
        {
        ...
        public override void InitNode()
        {
            ...
            m_nodeType = NodeType.NormalsFromHeight;
            ...
            m_outputs[0].outputLabel = "Normal Map";
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel("Normal from Height");
            ...
            m_showNormalMapSettings = DD_GUILayOut.FoldOut(m_showNormalMapSettings, "Normal Map Settings");

            if (m_showNormalMapSettings)
            {
                EditorGUI.BeginChangeCheck();
                m_normalStrength = DD_GUILayOut.Slider("Strength", m_normalStrength, 0, 1);
                m_overdetermination = DD_GUILayOut.IntField("Overdet.", (int)m_overdetermination);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                //DD_NodeUtils.NormalsFromHeight(inputTexture, m_outputs[0].outputTexture, m_normalStrength, m_overdetermination, m_bias);
                DD_NodeUtils.Blur(inputTexture, inputTexture2, m_smoothness / 250);
                inputTexture2.Apply();

                DD_NodeUtils.NormalsFromHeight(inputTexture2, m_outputs[0].outputTexture, m_normalStrength, m_overdetermination, m_bias);
            }
