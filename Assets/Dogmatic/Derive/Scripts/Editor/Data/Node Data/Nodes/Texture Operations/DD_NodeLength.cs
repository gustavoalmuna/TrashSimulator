...
{
    [Serializable]
    public class DD_NodeLength : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Length.ToString());
        ...
        /// <summary>
        /// Draws the length of each pixel treating them as vectors and stores the result in the output texture
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Length(inputTexture, m_outputs[0].outputTexture);
