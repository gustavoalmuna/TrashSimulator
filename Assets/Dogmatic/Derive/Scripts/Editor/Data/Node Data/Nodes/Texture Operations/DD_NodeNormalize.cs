...
{
    [Serializable]
    public class DD_NodeNormalize : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Normalize.ToString());
        ...
        /// <summary>
        /// Normalizes the value of each pixel treating them as vectors and stores the result in the output texture
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Normalize(inputTexture, m_outputs[0].outputTexture);
