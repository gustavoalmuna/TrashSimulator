...
{
    [Serializable]
    public class DD_NodeSqrt : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Sqrt.ToString());
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Sqrt(inputTexture, m_outputs[0].outputTexture);
