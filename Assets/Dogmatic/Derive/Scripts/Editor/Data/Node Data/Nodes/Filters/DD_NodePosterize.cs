...
{
    [Serializable]
    public class DD_NodePosterize : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Posterize.ToString());

            EditorGUI.BeginChangeCheck();
            m_strength = DD_GUILayOut.Slider("Strength", m_strength, 1, 300);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Posterize(inputTexture, m_outputs[0].outputTexture, m_strength);
