...
{
    [Serializable]
    public class DD_NodePixelate : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Pixelate.ToString());

            EditorGUI.BeginChangeCheck();
            m_size = DD_GUILayOut.Slider("Size", m_size, 0, 1);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Pixelate(inputTexture, m_outputs[0].outputTexture, m_size);
