...
namespace Derive
{
    public enum SEAMLESSMAPPINGMODE
    {
        CircularBlend,
        InverseCircularBlend,
        DiamondBlend,
        PolygonalBlend,
        MirroredEdges
    }
    ...
    [Serializable]
    public class DD_NodeSeamlessMapping : DD_NodeBase
    {
        #region public variables
        public SEAMLESSMAPPINGMODE m_seamlessMappingMode = SEAMLESSMAPPINGMODE.CircularBlend;
        public float m_falloff = 5;
        #endregion
        ...
        public override void InitNode()
        {
            ...
            m_nodeType = NodeType.SeamlessMapping;
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel("Seamless Mapping");

            EditorGUI.BeginChangeCheck();

            EditorGUILayout.BeginHorizontal();
            GUILayout.Label(new GUIContent("Mode"), DD_EditorUtils.editorSkin.GetStyle("DefaultLabel"), GUILayout.Width(100));
            m_seamlessMappingMode = (SEAMLESSMAPPINGMODE)EditorGUILayout.EnumPopup(new GUIContent(" "), m_seamlessMappingMode, DD_EditorUtils.editorSkin.GetStyle("EnumPopup"), GUILayout.Width(DD_EditorUtils.viewRect_propertyView.width - 150));
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.Space(10);

            if (m_seamlessMappingMode != SEAMLESSMAPPINGMODE.MirroredEdges)
            {
                m_falloff = DD_GUILayOut.FloatField("Falloff", m_falloff);
                EditorGUILayout.Space(10);
            }                
        ...
        /// <summary>
        /// Tiles and offsets the input texture based on m_tiling & m_offset and stores the result as output texture
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.SeamlessMapping(inputTexture, m_outputs[0].outputTexture, m_falloff, m_seamlessMappingMode);
