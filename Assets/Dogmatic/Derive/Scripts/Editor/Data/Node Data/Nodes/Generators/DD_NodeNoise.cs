...
namespace Derive
{
    ...
    [Serializable]
    public class DD_NodeNoise : DD_NodeBase
    {
        #region public variables
        public NOISETYPE m_noiseType = NOISETYPE.SolidNoise;
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Noise.ToString());
            ...
            m_showNoiseSettings = DD_GUILayOut.FoldOut(m_showNoiseSettings, "Noise Settings");
            ...
            if (m_showNoiseSettings)
            {
                ...
                GUILayout.Label(new GUIContent("Noise Type"), DD_EditorUtils.editorSkin.GetStyle("DefaultLabel"), GUILayout.Width(100));
                m_noiseType = (NOISETYPE)EditorGUILayout.EnumPopup(new GUIContent(" "), m_noiseType, DD_EditorUtils.editorSkin.GetStyle("EnumPopup"), GUILayout.Width(DD_EditorUtils.viewRect_propertyView.width - 150));
                ...
                if(m_noiseType == NOISETYPE.SolidNoise)
        ...
        /// <summary>
        /// Generates a simplex noise and stores it in the output texture
        /// </summary>
        void Perform()
        {
            m_outputs[0].outputTexture = new Texture2D(1, 1, TextureFormat.RGBAHalf, false);

            DD_NodeUtils.Noise(m_outputs[0].outputTexture, m_scale, m_seed, m_tiling, m_octaves, m_noiseType);
