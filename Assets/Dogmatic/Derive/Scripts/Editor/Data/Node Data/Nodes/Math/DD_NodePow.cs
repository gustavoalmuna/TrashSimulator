...
{
    [Serializable]
    public class DD_NodePow : DD_NodeBase
    {
        #region public variables
        public float m_base = 0;
        ...
        public override void InitNode()
        {
            ...
            m_inputs[0].inputLabel = "Base";
            m_inputs[1].inputLabel = "Exp";
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel("Power");

            EditorGUILayout.Space(10);

            EditorGUI.BeginChangeCheck();
            if (m_inputs[0].inputtingNode == null)
                m_base = DD_GUILayOut.FloatField("Base", m_base);

            if (m_inputs[1].inputtingNode == null)
                m_exp = DD_GUILayOut.FloatField("Exp", m_exp);
        ...
        void Perform()
        {
            ...
            if(m_inputs[0].inputtingNode == null)
            {
                textureA.SetPixel(0, 0, new Color(m_base, m_base, m_base, m_base));
                textureA.Apply();
            }
            ...
            if(m_inputs[1].inputtingNode == null)
            {
                textureB.SetPixel(0, 0, new Color(m_exp, m_exp, m_exp, m_exp));
                textureB.Apply();
            }
            else textureB = m_inputs[1].inputtingNode.m_outputs[m_inputs[1].outputIndex].outputTexture;

            DD_NodeUtils.Pow(textureA, textureB, m_outputs[0].outputTexture);
