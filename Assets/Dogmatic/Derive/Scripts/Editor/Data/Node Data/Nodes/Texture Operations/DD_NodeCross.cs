...
{
    [Serializable]
    public class DD_NodeCross : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Cross.ToString());
        ...
        /// <summary>
        /// Calculates the a cross product per each pixel of the input textures treating them as vectors and stores the result in the output texture
        /// </summary>
        void Perform()
        {
            ...
            DD_NodeUtils.Cross(textureA, textureB, m_outputs[0].outputTexture);
