...
{
    [Serializable]
    public class DD_NodeTilingOffset : DD_NodeBase
    {
        ...
        public override void InitNode()
        {
            ...
            m_nodeType = NodeType.TilingOffset;
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel("Tiling & Offset");

            EditorGUI.BeginChangeCheck();
            m_tiling = DD_GUILayOut.Vector2Field("Tiling", m_tiling);
            m_offset = DD_GUILayOut.Vector2Field("Offset", m_offset);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.TilingAndOffset(inputTexture, m_outputs[0].outputTexture, m_tiling, m_offset);
