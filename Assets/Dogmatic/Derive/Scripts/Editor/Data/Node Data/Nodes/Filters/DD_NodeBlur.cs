...
{
    [Serializable]
    public class DD_NodeBlur : DD_NodeBase
    {
        #region public variables
        public float m_blurStrength = 0.2f;
        #endregion
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Blur.ToString());

            EditorGUI.BeginChangeCheck();
            m_blurStrength = DD_GUILayOut.Slider("Strength", m_blurStrength, 0, 1);
        ...
        /// <summary>
        /// Performs the actual node operation blurring the input
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Blur(inputTexture, m_outputs[0].outputTexture, m_blurStrength / 250);
