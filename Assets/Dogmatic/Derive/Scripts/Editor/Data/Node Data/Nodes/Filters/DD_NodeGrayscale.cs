...
{
    [Serializable]
    public class DD_NodeGrayscale : DD_NodeBase
    {
        ...
        public override void InitNode()
        {
            ...
            m_outputs[0].outputLabel = "Grayscale";
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Grayscale.ToString());
        ...
        /// <summary>
        /// Performs the actual node operation turning the output into a grayscale version of the input
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Grayscale(inputTexture, m_outputs[0].outputTexture);
            }
