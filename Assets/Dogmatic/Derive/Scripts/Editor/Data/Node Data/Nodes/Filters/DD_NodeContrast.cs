...
{
    [Serializable]
    public class DD_NodeContrast : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Contrast.ToString());

            EditorGUI.BeginChangeCheck();
            m_contrast = DD_GUILayOut.Slider("Contrast", m_contrast, 0, 3);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Contrast(inputTexture, m_outputs[0].outputTexture, m_contrast);
