...
{
    [Serializable]
    public class DD_NodeOneMinus : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.OneMinus.ToString());
        ...
        /// <summary>
        /// Performs the actual node operation taking the input and subtracting it from 1
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                inputTexture1.SetPixel(0, 0, new Color(1, 1, 1, 0));
                inputTexture1.Apply();

                Texture2D inputTexture2 = new Texture2D(1, 1, TextureFormat.RGBAHalf, false);
                inputTexture2 = m_inputs[0].inputtingNode.m_outputs[m_inputs[0].outputIndex].outputTexture;

                DD_NodeUtils.TextureMath(inputTexture1, inputTexture2, m_outputs[0].outputTexture, MATHNODETYPE.Subtract);
