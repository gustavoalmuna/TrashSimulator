...
{
    [Serializable]
    public class DD_NodeFract : DD_NodeBase
    {
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Fract.ToString());
        ...
        /// <summary>
        /// Performs the actual node operation returning the fractional remainder of the input
        /// </summary>
        void Perform()
        {
            ...
            else
            {
                ...
                DD_NodeUtils.Fract(inputTexture, m_outputs[0].outputTexture);
