...
{
    [Serializable]
    public class DD_NodeBrightness : DD_NodeBase
    {
        ...
        public override void InitNode()
        {
            ...
            m_nodeType = NodeType.Brightness;
        ...
        public override void DrawProperties()
        {
            ...
            DD_GUILayOut.TitleLabel(NodeType.Brightness.ToString());

            EditorGUI.BeginChangeCheck();
            m_brightness = DD_GUILayOut.Slider("Brightness", m_brightness, 0, 5);
        ...
        void Perform()
        {
            ...
            else
            {
                ...
                inputTexture2.SetPixel(0, 0, new Color(m_brightness * 2 - 1, m_brightness * 2 - 1, m_brightness * 2 - 1, 1));

                inputTexture2.Apply();

                DD_NodeUtils.Brightness(inputTexture, m_outputs[0].outputTexture, m_brightness);
