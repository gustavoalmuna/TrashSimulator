...
Shader "Derive/POM (Mobile)"
{
	Properties
	{
		...
		[Toggle]_SpecularMapPresent("Specular Map Present", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 appendResult86 = (float3(-tex2DNode14.r , -tex2DNode14.g , tex2DNode14.b));
			float3 lerpResult56 = lerp( float3(0,0,1) , appendResult86 , _NormalStrength);
			float3 NormalMap100 = lerpResult56;
			o.Normal = NormalMap100;
			float4 Albedo96 = (( _AlbedoPresent )?( tex2D( _MainTex, customUVs39, DDX61, DDY62 ) ):( _MainColor ));
			o.Albedo = Albedo96.rgb;
			float Gloss106 = (( _SpecularMapPresent )?( ( _Gloss * tex2D( _SpecularMap, customUVs39, DDX61, DDY62 ).a ) ):( _Gloss ));
			float temp_output_108_0 = Gloss106;
			o.Specular = temp_output_108_0;
			o.Gloss = temp_output_108_0;
			o.Alpha = 1;
		}
	...
	Fallback "Diffuse"
	CustomEditor "DeriveUtils.DD_ShaderGUI_Mobile"
}