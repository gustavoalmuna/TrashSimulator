...
Shader "Hidden/Derive/Math/Math"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				finalColor = (( _MulDiv )?( (( _Divide )?( ( tex2DNode3 / tex2DNode4 ) ):( ( tex2DNode3 * tex2DNode4 ) )) ):( (( _Subtract )?( ( tex2DNode3 - tex2DNode4 ) ):( ( tex2DNode3 + tex2DNode4 ) )) ));
