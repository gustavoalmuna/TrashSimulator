...
Shader "Hidden/Derive/Math/Lerp"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 lerpResult20 = lerp( tex2D( _TextureInput1, uv_TextureInput1 ) , tex2D( _TextureInput2, uv_TextureInput2 ) , tex2D( _TextureInput3, uv_TextureInput3 ));
