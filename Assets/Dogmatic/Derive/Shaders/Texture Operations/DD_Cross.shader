...
Shader "Hidden/Derive/Texture Operations/Cross"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				finalColor = float4( cross( tex2D( _TextureInput1, uv_TextureInput1 ).rgb , tex2D( _TextureInput2, uv_TextureInput2 ).rgb ) , 0.0 );
