...
Shader "Hidden/Derive/Texture Operations/Normalize"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 normalizeResult12 = ASESafeNormalize( tex2D( _TextureInput, uv_TextureInput ) );
				

				finalColor = normalizeResult12;
