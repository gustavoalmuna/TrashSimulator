...
Shader "Hidden/Derive/Texture Operations/Dot"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float dotResult10 = dot( tex2D( _TextureInput1, uv_TextureInput1 ) , tex2D( _TextureInput2, uv_TextureInput2 ) );
				float4 temp_cast_0 = (dotResult10).xxxx;
