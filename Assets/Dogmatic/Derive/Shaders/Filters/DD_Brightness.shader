...
Shader "Hidden/Derive/Filters/Brightness"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float3 hsvTorgb21 = RGBToHSV( tex2D( _TextureInput, uv_TextureInput ).rgb );
				float3 hsvTorgb22 = HSVToRGB( float3(hsvTorgb21.x,hsvTorgb21.y,( hsvTorgb21.z * _Strength )) );
