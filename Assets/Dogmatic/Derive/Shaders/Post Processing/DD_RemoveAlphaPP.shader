...
Shader "Hidden/Derive/Post Processing/Remove Alpha Post Processing"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _TextureInput, uv_TextureInput );
				float4 appendResult23 = (float4(tex2DNode1.r , tex2DNode1.g , tex2DNode1.b , 0.7));
