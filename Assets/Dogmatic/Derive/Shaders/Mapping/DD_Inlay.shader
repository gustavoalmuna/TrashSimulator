...
Shader "Hidden/Derive/Mapping/Inlay"
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , tex2D( _TextureInput, texCoord8 ) , min( step( abs( ( texCoord8.x - ( _OffsetX + extentX43 ) ) ) , temp_output_53_0 ) , step( abs( ( -texCoord8.y - ( _OffsetY + extentY44 ) ) ) , temp_output_52_0 ) ));
